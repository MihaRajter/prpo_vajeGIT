...
@NamedQueries(value =
        {
                ...
                @NamedQuery(name = "Artikel.getone", query = "SELECT o FROM artikel o WHERE o.Artikel_id = :Artikel_id"),
                @NamedQuery(name = "Artikel.getone", query = "SELECT o FROM artikel o WHERE o.ime = :ime")
        })
